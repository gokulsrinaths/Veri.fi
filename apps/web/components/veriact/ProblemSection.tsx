      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {problems.map((item) => (
          <motion.div
            ...
            transition={spring}
            className="rounded-xl border border-zinc-700/80 p-5 bg-zinc-900/50 hover:border-zinc-600/80 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20"
          >
